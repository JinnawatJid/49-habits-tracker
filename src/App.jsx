...
const SEQUENTIAL_49_LEVELS = [
  {
    ...
    description: 'ใช้เวลานอกบ้านอย่างน้อยวันละ 30 นาที',
    targetDays: 7,
    isDefined: true
  },
  {
  ...
  {
    level: 3,
    title: 'อยากสมองดีให้อยู่เฉยๆ',
    description: 'อยู่เฉยๆ 15 นาที เพื่อให้สมองได้พักผ่อนอย่างแท้จริง',
    targetDays: 7,
    isDefined: true
  },
  {
  ...
  },
  {
    level: 5,
    title: 'จอดำบ้างก็ได้',
    description: 'ลดช่วงเวลา screentime ให้เหลือไม่เกิน 6 ชั่วโมง',
    targetDays: 7,
    isDefined: true
  },
  ...Array.from({ length: 44 }, (_, i) => ({
    level: i + 6,
    title: `Locked Habit (Chapter ${i + 6})`,
    description: `Unlock by completing Level ${i + 5} (7 Days Sprint)`,
    targetDays: 7,
    isDefined: false
  }))
];
